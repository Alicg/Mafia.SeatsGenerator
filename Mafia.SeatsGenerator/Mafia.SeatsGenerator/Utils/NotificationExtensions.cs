...
namespace Mafia.SeatsGenerator.Utils
{
    public static class NotificationExtensions
    {
        ...
        public static IObservable<T> OnAnyPropertyChanges<T>(this T source, string propertyName = null)
            where T : INotifyPropertyChanged
        {
            return Observable.FromEventPattern<PropertyChangedEventHandler, PropertyChangedEventArgs>(
                    ...
                    h => source.PropertyChanged -= h)
                .Where(v => propertyName == null || v.EventArgs.PropertyName == propertyName).Select(_ => source);
        }
    }
}